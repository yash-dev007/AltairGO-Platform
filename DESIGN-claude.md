...
- **Green Brand** (`#5ac576`): The core brand color — a light green used for primary CTA buttons, brand moments, and the signature accent. Deliberately earthy and un-tech.
